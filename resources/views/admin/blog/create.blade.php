...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-end"><a href="{{route('news.index')}}" class="btn btn-sm btn-dark @if(Request::routeIs('news.index')) active @endif">
                <i class="las la-arrow-left"></i> {{__('All News')}}
                </a>
            </h4>
        </div>
        <div class="card-body">
            {!! Form::open(array('route' => 'news.store', 'class' => 'forms-sample', 'method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
                <div class="row">
                    <div class="col-md-4">
